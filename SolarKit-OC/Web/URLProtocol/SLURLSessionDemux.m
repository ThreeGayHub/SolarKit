...
@interface SLURLSessionDemuxTask : NSObject
...
@interface SLURLSessionDemuxTask ()
...
@implementation SLURLSessionDemuxTask
...
@interface SLURLSessionDemux () <NSURLSessionDataDelegate>
...
@implementation SLURLSessionDemux
                                        ...
                                        modes:(nullable NSArray *)modes
{
  ...
  SLURLSessionDemuxTask *demuxTask = [[SLURLSessionDemuxTask alloc] initWithTask:dataTask delegate:delegate modes:modes];
...
- (SLURLSessionDemuxTask *)demuxTaskForTask:(NSURLSessionTask *)task
{
  SLURLSessionDemuxTask *demuxTask = nil;
...
{
  SLURLSessionDemuxTask *demuxTask = [self demuxTaskForTask:task];
...
{
  SLURLSessionDemuxTask *demuxTask = [self demuxTaskForTask:dataTask];
